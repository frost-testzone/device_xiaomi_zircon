...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BuildDesc="zircon_global-user 14 UP1A.231005.007 V816.0.7.0.UNOMIXM release-keys" \
    BuildFingerprint=Redmi/zircon_global/zircon:14/UP1A.231005.007/V816.0.7.0.UNOMIXM:user/release-keys \
